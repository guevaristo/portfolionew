...
public class CalculoIMC extends JFrame {
	...
	public CalculoIMC() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(CalculoIMC.class.getResource("/icones/iconfinder_09_Calculator_1871426.png")));
		...
		lblPeso.setBounds(89, 30, 48, 14);
		contentPane.add(lblPeso);

		JLabel lblAltura = new JLabel("Altura");
		lblAltura.setBounds(89, 66, 48, 14);
		contentPane.add(lblAltura);

		txtPeso = new JTextField();
		txtPeso.setBounds(147, 27, 96, 20);
		contentPane.add(txtPeso);
		txtPeso.setColumns(10);

		txtAltura = new JTextField();
		txtAltura.setBounds(147, 63, 96, 20);
		contentPane.add(txtAltura);
		txtAltura.setColumns(10);

		JLabel lblimc = new JLabel("IMC:");
		lblimc.setBounds(263, 44, 48, 14);
		contentPane.add(lblimc);

		txtIMC = new JTextField();
		txtIMC.setBounds(263, 63, 96, 20);
		...
		btnCalcular.setBounds(10, 13, 61, 70);
